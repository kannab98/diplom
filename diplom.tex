...
\bibliography{sections/retracking, sections/water}
\newpage
...
\lstinputlisting[label={lst:surface}, caption={Вычисление спектра волнения как
кусочно-аналитической функции}]{scripts/surface.py}
